...
pizza you should have one line of output containing a simple statement
 ...
 */
// Solution:
let favorite_pizza = ["Pepperoni", "Fagita", "chicken", "Malai Chicken"];
for (const favorite of favorite_pizza) {
    console.log(`I like ${favorite} pizza.`);
}
