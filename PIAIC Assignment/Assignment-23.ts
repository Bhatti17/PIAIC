...
let str2: boolean = str === str1; // False
let str3: boolean = str != str1;  //True

//  Tests using the lower case function

let lCstr: string = "AbDuLMoIz";
let lCstr1: boolean= lCstr.toLowerCase() === "abdulmoiz"; //true
...
export{}
 let num1: number = 10;
 let num2: number = 20;
 let isEqualNum: boolean = num1 === num2; //False
 let isNotNum: boolean = num1 != num2; //True
 let isGreaterNum: boolean = num1 > num2; // False
 let isLessNum: boolean = num1 < num2; // True
 let isEq_Lessnum: boolean = num1 >= num2  // False
 let isEq_Greaternum: boolean = num1 <= num2 // Ture
...
let c = 30;
let d = 40;
let andOprator:boolean = a < b && b>a //Ture
let oRoperator: boolean = c >= d || d <=c //False
let notOperator: boolean = a < d != c > b // False
// Test whether an item is in a array
let whether: string[] =["Abdul Moiz","Mateen","Zohaib","H.Shakeel"];
let findItem = "Mateen";
